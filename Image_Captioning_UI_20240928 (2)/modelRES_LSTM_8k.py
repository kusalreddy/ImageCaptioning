...
base_path = "."
image_embedding_file = base_path + "\Flickr8k\Extracts\clip_vit_b32_embeddings.pkl"
...
# Caption Directories
print("Debug: 4.3")
image_data_location = base_path  + "/Flickr8k"
captions_file = base_path + "/Flickr8k/captions.csv"
token_file = base_path + "/Flickr8k/Extracts/tokens.csv"
train_image_csv =  base_path + "/Flickr8k/Extracts/train_images.txt"
test_image_csv = base_path + "/Flickr8k/Extracts/test_images.txt"
val_image_csv = base_path + "/Flickr8k/Extracts/val_images.txt"
...
def predict_step(image):
    ...
    print("Debug: 11.2")
    model, optimizer, loaded_epoch = load_ckp(".\Checkpoints\RES_LSTM_8k_Checpoint_25.pt", model, optimizer)
    model.eval()
    print("Debug: 11.3")
    with torch.no_grad():
        print("image: ", image)
