...
def main():
    ...
    data_folder = "F:\Code\Image_Captioning"
    print(data_folder)
    image_folder = os.path.join(data_folder, "Flicker8k_Dataset")
    annotation_path = os.path.join(data_folder, "Flickr8k.lemma.token.txt")
    ...
    val_loader = load_data(val_list, word2int, batch_size=batch_size, num_workers=1) #num_workers=10)
    test_loader = load_data(test_list, word2int, batch_size=12, num_workers=1) #num_workers=10)
